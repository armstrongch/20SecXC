...
cpu_brain_types[4] = "random_drifter";
cpu_brain_types[5] = "player_watcher";
...
for (var i = 0; i < instance_number(Runner_obj); i += 1)
{
    ...
    test_runner.cpu_brain_type = cpu_brain_types[(i+rand_mod)%cpu_brain_type_count];
}
